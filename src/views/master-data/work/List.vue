            ...
            <div class="main-content">
                <div class="page-content">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12 mt-3">
                                <div class="page-title-box d-sm-flex align-items-start justify-content-between">
                                    <h4 class="mb-sm-0">Master Data Pekerjaan</h4>
                                    <div class="d-flex">
                                        ...
                                        <router-link to="/master-work/form" class="btn btn-primary button-rounded ms-2" type="button">Tambah Baru</router-link>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-md-12">
                                <div class="input-group-left">
                                    ...
                                    <input type="text" class="form-control input-group-form" placeholder="Cari data pekerjaan disini" v-model="keywords" @input="debouncedHandler">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <p>Menampilkan {{pagination.total}} data pekerjaan</p>
                                                ...
                                                <tr v-for="item in list">
                                                    ...
                                                    <td class="middle-item">
                                                        <div class="d-flex justify-content-end align-items-center">
                                                            <router-link :to="`master-work/form/${item.id}`" class="btn btn-square border bg-info text-white me-2"><i class="mdi mdi-circle-edit-outline fs-4"></i></router-link>
...
export default {
    ...
    methods: {
        fetchData(page) {
            ApiCore.get(`${apiEnpoint.ADMINISTRATION_MASTER}/work`, {
            ...
            this.$swal
                ...
                .then(async (result) => {
                    if (result.isConfirmed) {
                        try {
                            this.fetch = true
                            const process = await ApiCore.delete(`${apiEnpoint.ADMINISTRATION_MASTER}/work`, data.id)
                            this.fetch = false
                            if (process.status) {
            ...
            this.$swal
                ...
                .then(async (result) => {
                    if (result.isConfirmed) {
                        try {
                            this.fetch = true
                            const process = await ApiCore.bulkDelete(`${apiEnpoint.ADMINISTRATION_MASTER}/work`, selectedId)
                            this.fetch = false
                            if (process.status) {
                                this.$toast.success(process.message);
                                this.fetchData(this.pagination.page);
